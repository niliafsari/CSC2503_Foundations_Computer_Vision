...
addpath([hmdir 'util/']);
addpath([hmdir '../data/']);
addpath(['~jepson/pub/matlab/utvisToolbox/edge/']); % for cannyEdgels.m
cd([hmdir]);


% % Need to change this to refer to your startup.m 
% run /home/nilou/Dropbox/Courses/matlab/startup
% hmdir = '../cellFinder';
% 
% % Link the other handout directories for A2
% addpath(['/home/nilou/Dropbox/Courses/Vision/Assignemnts/handout/cellFinder']);
% addpath(['/home/nilou/Dropbox/Courses/Vision/Assignemnts/handout/cellFinder/util']);
% addpath(['/home/nilou/Dropbox/Courses/Vision/Assignemnts/handout/data'])
% addpath(['/home/nilou/Dropbox/Courses/Vision/Assignemnts/handout/cellFinder/circleFit'])
% cd([hmdir]);
...
sigmaGM = 24; % Geman-McLure estimator scale parameter
...
for iFname = 2:2  % Use 1 image for now, change to 1:nFname to process all
  ...
  minStrength = 25;  % Minimum edgel strength
